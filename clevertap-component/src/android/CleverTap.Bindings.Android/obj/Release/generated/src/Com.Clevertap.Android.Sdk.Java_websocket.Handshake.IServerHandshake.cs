...
namespace Com.Clevertap.Android.Sdk.Java_websocket.Handshake {
	...
	public partial interface IServerHandshake : global::Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IHandshakedata {
		...
		[Register ("getHttpStatus", "()S", "GetGetHttpStatusHandler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IServerHandshakeInvoker, CleverTap.Bindings.Android")]
		short GetHttpStatus ();
		...
		[Register ("getHttpStatusMessage", "()Ljava/lang/String;", "GetGetHttpStatusMessageHandler:Com.Clevertap.Android.Sdk.Java_websocket.Handshake.IServerHandshakeInvoker, CleverTap.Bindings.Android")]
	...
	internal partial class IServerHandshakeInvoker : global::Java.Lang.Object, IServerHandshake {

		internal static new readonly JniPeerMembers _members = new XAPeerMembers ("com/clevertap/android/sdk/java_websocket/handshake/ServerHandshake", typeof (IServerHandshakeInvoker));
