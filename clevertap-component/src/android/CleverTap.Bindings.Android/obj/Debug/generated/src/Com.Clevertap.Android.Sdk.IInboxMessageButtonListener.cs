...
namespace Com.Clevertap.Android.Sdk {
	...
	public partial interface IInboxMessageButtonListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onInboxButtonClick", "(Ljava/util/HashMap;)V", "GetOnInboxButtonClick_Ljava_util_HashMap_Handler:Com.Clevertap.Android.Sdk.IInboxMessageButtonListenerInvoker, CleverTap.Bindings.Android")]
	...
	internal partial class IInboxMessageButtonListenerInvoker : global::Java.Lang.Object, IInboxMessageButtonListener {

		internal static new readonly JniPeerMembers _members = new XAPeerMembers ("com/clevertap/android/sdk/InboxMessageButtonListener", typeof (IInboxMessageButtonListenerInvoker));
