...
namespace CleverTapSDK {
	...
	public partial interface ICTKnownProfileFields : INativeObject, IDisposable
	{
		...
		public static string GetStorageValueForField<T> (KnownField field) where T: NSObject, ICTKnownProfileFields
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static KnownField GetKnownFieldIfPossibleForKey<T> (string key) where T: NSObject, ICTKnownProfileFields
		{
			if (key is null)
...
namespace CleverTapSDK {
	...
	public unsafe partial class CTKnownProfileFields : NSObject, ICTKnownProfileFields {
		...
		/// <summary>Creates a new <see cref="CTKnownProfileFields" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
