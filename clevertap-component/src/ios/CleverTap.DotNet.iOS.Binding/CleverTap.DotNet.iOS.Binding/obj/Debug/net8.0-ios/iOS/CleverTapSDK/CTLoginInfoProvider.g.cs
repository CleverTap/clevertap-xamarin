...
namespace CleverTapSDK {
	...
	internal unsafe sealed class CTLoginInfoProviderWrapper : BaseWrapper, ICTLoginInfoProvider {
		[Preserve (Conditional = true)]
		public CTLoginInfoProviderWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
	}
...
namespace CleverTapSDK {
	...
	public unsafe partial class CTLoginInfoProvider : NSObject, ICTLoginInfoProvider {
			...
			: base (NSObjectFlag.Empty)
		{
			...
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_NativeHandle_NativeHandle (this.Handle, Selector.GetHandle ("initWithDeviceInfo:config:"), deviceInfo__handle__, config__handle__), "initWithDeviceInfo:config:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("initWithDeviceInfo:config:"), deviceInfo__handle__, config__handle__), "initWithDeviceInfo:config:");
			}
		}
		...
		public virtual void CacheGUID (string guid, string key, string identifier)
		{
			...
			if (IsDirectBinding) {
				...
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("cacheGUID:forKey:andIdentifier:"), nsguid, nskey, nsidentifier);
			}
			CFString.ReleaseNative (nsguid);
			CFString.ReleaseNative (nskey);
			CFString.ReleaseNative (nsidentifier);
		...
		public virtual string GetGUIDforKey (string key, string identifier)
		{
			...
			if (IsDirectBinding) {
				...
				ret = CFString.FromHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("getGUIDforKey:andIdentifier:"), nskey, nsidentifier))!;
			}
			CFString.ReleaseNative (nskey);
			CFString.ReleaseNative (nsidentifier);
			return ret!;
		...
		public virtual void RemoveValueFromCachedGUIDForKey (string key, string guid)
		{
			...
			if (IsDirectBinding) {
				...
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_NativeHandle_NativeHandle (this.SuperHandle, Selector.GetHandle ("removeValueFromCachedGUIDForKey:andGuid:"), nskey, nsguid);
			}
			CFString.ReleaseNative (nskey);
			CFString.ReleaseNative (nsguid);
		}
		...
		public virtual void SetCachedGUIDs (NSDictionary cache)
		{
			...
			if (IsDirectBinding) {
				...
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("setCachedGUIDs:"), cache__handle__);
			}
		}
		...
		public virtual void SetCachedIdentities (string cache)
		{
			...
			if (IsDirectBinding) {
				...
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_NativeHandle (this.SuperHandle, Selector.GetHandle ("setCachedIdentities:"), nscache);
			}
			CFString.ReleaseNative (nscache);
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual NSDictionary CachedGUIDs {
			...
			get {
				NSDictionary? ret;
				if (IsDirectBinding) {
					ret =  Runtime.GetNSObject<NSDictionary> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (this.Handle, Selector.GetHandle ("getCachedGUIDs")))!;
				} else {
					ret =  Runtime.GetNSObject<NSDictionary> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("getCachedGUIDs")))!;
				}
				return ret!;
			}
		}
		...
		public virtual string CachedIdentities {
			...
			get {
				if (IsDirectBinding) {
					...
					return CFString.FromHandle (global::ApiDefinition.Messaging.NativeHandle_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("getCachedIdentities")))!;
				}
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public virtual bool DeviceIsMultiUser {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					ret = global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("deviceIsMultiUser"));
				}
				return ret != 0;
			}
		}
		...
		public virtual bool IsAnonymousDevice {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					ret = global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("isAnonymousDevice"));
				}
				return ret != 0;
			}
		}
		...
		public virtual bool IsLegacyProfileLoggedIn {
			...
			get {
				...
				if (IsDirectBinding) {
					...
					ret = global::ApiDefinition.Messaging.bool_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("isLegacyProfileLoggedIn"));
				}
				return ret != 0;
			}
		}
