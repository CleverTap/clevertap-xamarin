...
namespace CleverTapSDK {
	...
	public partial interface ICTLogger : INativeObject, IDisposable
	{
		...
		public static void SetDebugLevel<T> (int level) where T: NSObject, ICTLogger
		{
		...
		[global::Foundation.OptionalMember]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static int GetDebugLevel<T> () where T: NSObject, ICTLogger
		{
			var class_ptr = Class.GetHandle (typeof (T));
			return global::ApiDefinition.Messaging.int_objc_msgSend (class_ptr, Selector.GetHandle ("getDebugLevel"));
		}
	}
	internal unsafe sealed class CTLoggerWrapper : BaseWrapper, ICTLogger {
		[Preserve (Conditional = true)]
		public CTLoggerWrapper (NativeHandle handle, bool owns)
			: base (handle, owns)
		{
		}
	}
...
namespace CleverTapSDK {
	...
	public unsafe partial class CTLogger : NSObject, ICTLogger {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly NativeHandle class_ptr = Class.GetHandle ("CTLogger");
		...
		/// <summary>Creates a new <see cref="CTLogger" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CTLogger (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
