...
namespace CleverTapSDK {
	[Register("ApiDefinition__CleverTapSDK_CTIdentityRepo", false)]
	[Model]
	public unsafe abstract partial class CTIdentityRepo : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CTIdentityRepo (NativeHandle handle) : base (handle)
		{
			IsDirectBinding = false;
		}
