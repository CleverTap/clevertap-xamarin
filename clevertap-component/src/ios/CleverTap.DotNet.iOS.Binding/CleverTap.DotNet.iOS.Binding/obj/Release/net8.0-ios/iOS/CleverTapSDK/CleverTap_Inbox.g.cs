...
namespace CleverTapSDK {
	public unsafe static partial class CleverTap_Inbox  {
		...
		{
			return CFArray.ArrayFromHandle<CleverTapInboxMessage>(global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("getAllInboxMessages")))!;
		}
		...
		public static void DeleteInboxMessage (this CleverTap This, CleverTapInboxMessage message)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("deleteInboxMessage:"), message__handle__);
		}
		...
		public static void DeleteInboxMessageForID (this CleverTap This, string messageId)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("deleteInboxMessageForID:"), nsmessageId);
		...
		public static void DeleteInboxMessagesForIDs (this CleverTap This, string[] messageIds)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("deleteInboxMessagesForIDs:"), nsa_messageIds.Handle);
		...
		public static CleverTapInboxMessage? GetInboxMessageForId (this CleverTap This, string messageId)
		{
			...
			ret =  Runtime.GetNSObject<CleverTapInboxMessage> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("getInboxMessageForId:"), nsmessageId))!;
			CFString.ReleaseNative (nsmessageId);
			return ret!;
		}
		...
		{
			return global::ApiDefinition.Messaging.UIntPtr_objc_msgSend (This.Handle, Selector.GetHandle ("getInboxMessageCount"));
		}
		[Export ("getInboxMessageUnreadCount")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static nuint InboxMessageUnreadCount (this CleverTap This)
		{
			return global::ApiDefinition.Messaging.UIntPtr_objc_msgSend (This.Handle, Selector.GetHandle ("getInboxMessageUnreadCount"));
		}
		...
		public unsafe static void InitializeInboxWithCallback (this CleverTap This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDCleverTapInboxSuccessBlock))]CleverTapInboxSuccessBlock callback)
		{
			...
			using var block_callback = Trampolines.SDCleverTapInboxSuccessBlock.CreateBlock (callback);
			BlockLiteral *block_ptr_callback = &block_callback;
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("initializeInboxWithCallback:"), (IntPtr) block_ptr_callback);
		}
		...
		{
			var message__handle__ = message!.GetNonNullHandle (nameof (message));
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("markReadInboxMessage:"), message__handle__);
		}
		...
		public static void MarkReadInboxMessageForID (this CleverTap This, string messageId)
		{
			if (messageId is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (messageId));
			var nsmessageId = CFString.CreateNative (messageId);
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("markReadInboxMessageForID:"), nsmessageId);
			CFString.ReleaseNative (nsmessageId);
		}
		...
		public static CleverTapInboxViewController? NewInboxViewControllerWithConfig (this CleverTap This, CleverTapInboxStyleConfig? config, CleverTapInboxViewControllerDelegate? @delegate)
		{
			...
			return  Runtime.GetNSObject<CleverTapInboxViewController> (global::ApiDefinition.Messaging.NativeHandle_objc_msgSend_NativeHandle_NativeHandle (This.Handle, Selector.GetHandle ("newInboxViewControllerWithConfig:andDelegate:"), config__handle__, @delegate__handle__))!;
		}
		...
		public static void RecordInboxNotificationClickedEventForID (this CleverTap This, string messageId)
		{
			if (messageId is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (messageId));
			var nsmessageId = CFString.CreateNative (messageId);
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("recordInboxNotificationClickedEventForID:"), nsmessageId);
			CFString.ReleaseNative (nsmessageId);
		}
		...
		public static void RecordInboxNotificationViewedEventForID (this CleverTap This, string messageId)
		{
			if (messageId is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (messageId));
			var nsmessageId = CFString.CreateNative (messageId);
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("recordInboxNotificationViewedEventForID:"), nsmessageId);
			CFString.ReleaseNative (nsmessageId);
		}
		...
		public unsafe static void RegisterInboxUpdatedBlock (this CleverTap This, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDCleverTapInboxUpdatedBlock))]CleverTapInboxUpdatedBlock block)
		{
			...
			using var block_block = Trampolines.SDCleverTapInboxUpdatedBlock.CreateBlock (block);
			BlockLiteral *block_ptr_block = &block_block;
			global::ApiDefinition.Messaging.void_objc_msgSend_NativeHandle (This.Handle, Selector.GetHandle ("registerInboxUpdatedBlock:"), (IntPtr) block_ptr_block);
		}
		[Export ("getUnreadInboxMessages")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static CleverTapInboxMessage[] UnreadInboxMessages (this CleverTap This)
		{
			return CFArray.ArrayFromHandle<CleverTapInboxMessage>(global::ApiDefinition.Messaging.NativeHandle_objc_msgSend (This.Handle, Selector.GetHandle ("getUnreadInboxMessages")))!;
		}
