...
namespace CleverTapSDK {
	...
	public unsafe partial class CTInAppPassThroughWindow : global::UIKit.UIWindow, ICTInAppPassThroughWindow {
		...
		/// <summary>Creates a new <see cref="CTInAppPassThroughWindow" /> with default values.</summary>
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		/// <summary>Appearance class for objects of type <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</summary>
		/// <remarks>
		///     <para>This appearance class is a strongly typed subclass of UIAppearance that is intended to be used with objects of class <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</para>
		///     <para>You can obtain an instance to this class by either accessing the static <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.Appearance" /> property or by calling <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.AppearanceWhenContainedIn(System.Type[])" /> to get a UIAppearance that is context sensitive.</para>
		/// </remarks>
		...
		/// <remarks>
		///   <para>Setting any appearance properties on this instance will affect the appearance of all instances of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</para>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />, they should use the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		/// </remarks>
		...
		/// <summary>Obtains the appearance proxy <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.CTInAppPassThroughWindowAppearance" /> for the subclass of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</summary>
		/// <typeparam name="T">The type for which the <see cref="global::UIKit.UIAppearance" /> proxy must be returned.  This is a subclass of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</typeparam>
		/// <returns>
		///   <para>An appearance proxy object for the specified type.</para>
		/// </returns>
		/// <remarks>
		///   <para>Setting any appearance properties on the returned object will affect the appearance of all classes and subclasses of the type parameter.</para>
		///   <para>Unlike the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.Appearance" /> property, or the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.AppearanceWhenContainedIn(System.Type[])" /> method which only work on instances of this particular class, the proxies returned by this method can be used to change the style of subclasses.</para>
		///   <para>The following example shows how this method works:</para>
		///   <example>
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTheme = CTInAppPassThroughWindow.GetAppearance<MyCTInAppPassThroughWindowSubclass> ();
		...
		/// <remarks>
		///   <para>The returned object represents the <see cref="global::UIKit.UIAppearance" /> proxy where developers can set appearance properties for instances of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" /> when those instances are contained in the hierarchy specified by the <paramref name="containers" /> parameter.</para>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />, they should use the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		///   <para>The following example shows how this method works:</para>
		///   <example>
		///     <code lang="csharp lang-csharp"><![CDATA[
		...
		/// <summary>Obtains the appearance proxy <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.CTInAppPassThroughWindowAppearance" /> for <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />.</summary>
		...
		///var myTheme = CTInAppPassThroughWindow.GetAppearance (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />, they should use the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.GetAppearance&lt;T&gt;(UIKit.UITraitCollection)" /> method.</para>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		/// </remarks>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = CTInAppPassThroughWindow.GetAppearance (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>If developers want to control the appearance of subclasses of <see cref="global::CleverTapSDK.CTInAppPassThroughWindow" />, they should use the <see cref="global::CleverTapSDK.CTInAppPassThroughWindow.GetAppearance&lt;T&gt;(UIKit.UITraitCollection,System.Type[])" /> method.</para>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = CTInAppPassThroughWindow.GetAppearance<MyCTInAppPassThroughWindowSubclass> (myTraits);
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
		...
		///   <code lang="csharp lang-csharp"><![CDATA[
		///var myTraits = new UITraitCollection ();
		///var myTheme = CTInAppPassThroughWindow.GetAppearance<MyCTInAppPassThroughWindowSubclass> (myTraits, typeof (UINavigationBar), typeof (UIPopoverController));
		///myTheme.TintColor = UIColor.Red;
		///]]></code>
		///   </example>
		///   <para>For more information, see the documentation for the <see cref="global::UIKit.UIAppearance" /> class.</para>
