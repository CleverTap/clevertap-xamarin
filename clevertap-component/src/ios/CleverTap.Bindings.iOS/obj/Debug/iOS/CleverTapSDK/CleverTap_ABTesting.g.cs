...
namespace CleverTapSDK {
	public unsafe static partial class CleverTap_ABTesting  {
		...
		public static NSDictionary<NSString, NSNumber> GetDictionaryOfBoolVariableWithName (this CleverTap This, string name, NSDictionary<NSString, NSNumber> defaultValue)
		{
			if (name == null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (name));
			var defaultValue__handle__ = defaultValue.GetNonNullHandle (nameof (defaultValue));
			var nsname = NSString.CreateNative (name);
			
			NSDictionary<NSString, NSNumber> ret;
			ret =  Runtime.GetNSObject<NSDictionary<NSString, NSNumber>> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (This.Handle, Selector.GetHandle ("getDictionaryOfBoolVariableWithName:defaultValue:"), nsname, defaultValue__handle__));
			NSString.ReleaseNative (nsname);
		...
		public static NSDictionary<NSString, NSNumber> GetDictionaryOfDoubleVariableWithName (this CleverTap This, string name, NSDictionary<NSString, NSNumber> defaultValue)
		{
			...
			NSDictionary<NSString, NSNumber> ret;
			ret =  Runtime.GetNSObject<NSDictionary<NSString, NSNumber>> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (This.Handle, Selector.GetHandle ("getDictionaryOfDoubleVariableWithName:defaultValue:"), nsname, defaultValue__handle__));
			NSString.ReleaseNative (nsname);
		...
		public static NSDictionary<NSString, NSNumber> GetDictionaryOfIntegerVariableWithName (this CleverTap This, string name, NSDictionary<NSString, NSNumber> defaultValue)
		{
			...
			NSDictionary<NSString, NSNumber> ret;
			ret =  Runtime.GetNSObject<NSDictionary<NSString, NSNumber>> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (This.Handle, Selector.GetHandle ("getDictionaryOfIntegerVariableWithName:defaultValue:"), nsname, defaultValue__handle__));
			NSString.ReleaseNative (nsname);
		...
		public static NSDictionary<NSString, NSString> GetDictionaryOfStringVariableWithName (this CleverTap This, string name, NSDictionary<NSString, NSString> defaultValue)
		{
			...
			ret =  Runtime.GetNSObject<NSDictionary<NSString, NSString>> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (This.Handle, Selector.GetHandle ("getDictionaryOfStringVariableWithName:defaultValue:"), nsname, defaultValue__handle__));
			NSString.ReleaseNative (nsname);
