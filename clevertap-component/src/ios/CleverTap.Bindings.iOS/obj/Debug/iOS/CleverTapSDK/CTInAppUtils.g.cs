...
namespace CleverTapSDK {
	...
	public unsafe partial class CTInAppUtils : NSObject {
		...
		public static string? GetXibNameForControllerName (string controllerName)
		{
			...
			string? ret;
			ret = CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("getXibNameForControllerName:"), nscontrollerName))!;
		...
		public static CTInAppType InAppTypeFromString (string type)
		{
			...
			CTInAppType ret;
			ret = (CleverTapSDK.CTInAppType) (ulong) global::ApiDefinition.Messaging.UIntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("inAppTypeFromString:"), nstype);
