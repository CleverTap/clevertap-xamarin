...
namespace CleverTapSDK {
	...
	public static partial class CleverTapDomainDelegate_Extensions {
		...
		public static void OnSCDomainAvailable (this ICleverTapDomainDelegate This, string domain)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (This.Handle, Selector.GetHandle ("onSCDomainAvailable:"), nsdomain);
	...
	internal sealed class CleverTapDomainDelegateWrapper : BaseWrapper, ICleverTapDomainDelegate {
		[Preserve (Conditional = true)]
		public CleverTapDomainDelegateWrapper (IntPtr handle, bool owns)
			: base (handle, owns)
		{
		}
	}
...
namespace CleverTapSDK {
	...
	public unsafe partial class CleverTapDomainDelegate : NSObject, ICleverTapDomainDelegate {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CleverTapDomainDelegate (IntPtr handle) : base (handle)
		{
			IsDirectBinding = false;
		}
