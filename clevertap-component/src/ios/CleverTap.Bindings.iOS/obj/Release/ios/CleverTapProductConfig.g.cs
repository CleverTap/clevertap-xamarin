...
namespace CleverTapSDK {
	...
	public interface ICleverTapProductConfig : INativeObject, IDisposable
	{
	}
	...
	public unsafe partial class CleverTapProductConfig : NSObject, ICleverTapProductConfig {
		...
		public virtual void SetDefaults (NSDictionary<NSString, NSObject> defaults)
		{
			if (IsDirectBinding) {
				...
				global::ApiDefinition.Messaging.void_objc_msgSendSuper_IntPtr (this.SuperHandle, Selector.GetHandle ("setDefaults:"), defaults == null ? IntPtr.Zero : defaults.Handle);
			}
		}
