...
namespace CleverTapSDK {
	...
	internal sealed class CTUIUtilsWrapper : BaseWrapper, ICTUIUtils {
		[Preserve (Conditional = true)]
		public CTUIUtilsWrapper (IntPtr handle, bool owns)
			: base (handle, owns)
		{
		}
	}
...
namespace CleverTapSDK {
	...
	public unsafe partial class CTUIUtils : NSObject, ICTUIUtils {
		...
		static readonly IntPtr class_ptr = Class.GetHandle ("CTUIUtils");
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CTUIUtils (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		public static global::UIKit.UIImage GetImageForName (string name)
		{
			...
			ret =  Runtime.GetNSObject<global::UIKit.UIImage> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("getImageForName:"), nsname))!;
		...
		public static bool IsDeviceOrientationLandscape {
			...
			get {
				return global::ApiDefinition.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("isDeviceOrientationLandscape"));
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static bool IsUserInterfaceIdiomPad {
			...
			get {
				return global::ApiDefinition.Messaging.bool_objc_msgSend (class_ptr, Selector.GetHandle ("isUserInterfaceIdiomPad"));
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static global::UIKit.UIWindow? KeyWindow {
			...
			get {
				...
				ret =  Runtime.GetNSObject<global::UIKit.UIWindow> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("getKeyWindow")))!;
				return ret!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
