...
namespace CleverTapSDK {
	...
	internal sealed class CTLegacyIdentityRepoWrapper : BaseWrapper, ICTLegacyIdentityRepo {
		[Preserve (Conditional = true)]
		public CTLegacyIdentityRepoWrapper (IntPtr handle, bool owns)
			: base (handle, owns)
		{
		}
		[Export ("isIdentity:")]
...
namespace CleverTapSDK {
	...
	public unsafe partial class CTLegacyIdentityRepo : NSObject, ICTLegacyIdentityRepo, ICTIdentityRepo {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly IntPtr class_ptr = Class.GetHandle ("CTLegacyIdentityRepo");
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal CTLegacyIdentityRepo (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
