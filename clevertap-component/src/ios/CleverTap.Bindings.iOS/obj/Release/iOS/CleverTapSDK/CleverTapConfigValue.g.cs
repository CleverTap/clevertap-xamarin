...
namespace CleverTapSDK {
	...
	public static partial class CleverTapConfigValue_Extensions {
		...
		{
			return CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (This.Handle, Selector.GetHandle ("stringValue")))!;
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		...
		public virtual string? StringValue {
			...
			get {
				if (IsDirectBinding) {
					...
					return CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper (this.SuperHandle, Selector.GetHandle ("stringValue")))!;
				}
			}
		}
