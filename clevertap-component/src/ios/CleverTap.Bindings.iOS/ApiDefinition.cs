...
namespace CleverTapSDK
{
    ...
    {
        // @required -(void)handleNotificationCTA:(NSURL *)ctaURL forNotification:(CTInAppNotification *)notification fromViewController:(CTInAppDisplayViewController *)controller withExtras:(NSDictionary *)extras;
        [Abstract]
    ...
    {
        // +(void)getLocationWithSuccess:(void (^)(CLLocationCoordinate2D))success andError:(void (^)(NSString *))error;
        [Static]
        [Export("getLocationWithSuccess:andError:")]
        void GetLocationWithSuccess(Action<CLLocationCoordinate2D> success, Action<NSString> error);
    }
    ...
    interface CTProfileBuilder
    {
        ...
        // +(void)buildSetMultiValues:(NSArray<NSString *> * _Nonnull)values forKey:(NSString * _Nonnull)key localDataStore:(CTLocalDataStore * _Nonnull)dataStore completionHandler:(void (^ _Nonnull)(NSDictionary * _Nullable, NSArray * _Nullable, NSArray<CTValidationResult *> * _Nullable))completion;
        [Static]
        [Export("buildSetMultiValues:forKey:localDataStore:completionHandler:")]
        void BuildSetMultiValues(string[] values, string key, CTLocalDataStore dataStore, Action<NSDictionary, NSArray, NSArray<CTValidationResult>> completion);

        // +(void)buildAddMultiValue:(NSString * _Nonnull)value forKey:(NSString * _Nonnull)key localDataStore:(CTLocalDataStore * _Nonnull)dataStore completionHandler:(void (^ _Nonnull)(NSDictionary * _Nullable, NSArray * _Nullable, NSArray<CTValidationResult *> * _Nullable))completion;
        [Static]
        [Export("buildAddMultiValue:forKey:localDataStore:completionHandler:")]
        void BuildAddMultiValue(string value, string key, CTLocalDataStore dataStore, Action<NSDictionary, NSArray, NSArray<CTValidationResult>> completion);

        // +(void)buildAddMultiValues:(NSArray<NSString *> * _Nonnull)values forKey:(NSString * _Nonnull)key localDataStore:(CTLocalDataStore * _Nonnull)dataStore completionHandler:(void (^ _Nonnull)(NSDictionary * _Nullable, NSArray * _Nullable, NSArray<CTValidationResult *> * _Nullable))completion;
        [Static]
        [Export("buildAddMultiValues:forKey:localDataStore:completionHandler:")]
        void BuildAddMultiValues(string[] values, string key, CTLocalDataStore dataStore, Action<NSDictionary, NSArray, NSArray<CTValidationResult>> completion);

        // +(void)buildRemoveMultiValue:(NSString * _Nonnull)value forKey:(NSString * _Nonnull)key localDataStore:(CTLocalDataStore * _Nonnull)dataStore completionHandler:(void (^ _Nonnull)(NSDictionary * _Nullable, NSArray * _Nullable, NSArray<CTValidationResult *> * _Nullable))completion;
        [Static]
        [Export("buildRemoveMultiValue:forKey:localDataStore:completionHandler:")]
        void BuildRemoveMultiValue(string value, string key, CTLocalDataStore dataStore, Action<NSDictionary, NSArray, NSArray<CTValidationResult>> completion);

        // +(void)buildRemoveMultiValues:(NSArray<NSString *> * _Nonnull)values forKey:(NSString * _Nonnull)key localDataStore:(CTLocalDataStore * _Nonnull)dataStore completionHandler:(void (^ _Nonnull)(NSDictionary * _Nullable, NSArray * _Nullable, NSArray<CTValidationResult *> * _Nullable))completion;
        [Static]
        [Export("buildRemoveMultiValues:forKey:localDataStore:completionHandler:")]
        void BuildRemoveMultiValues(string[] values, string key, CTLocalDataStore dataStore, Action<NSDictionary, NSArray, NSArray<CTValidationResult>> completion);
    }
    ...
    {
        // @required -(void)messageDidSelect:(CleverTapInboxMessage * _Nonnull)message atIndex:(int)index withButtonIndex:(int)buttonIndex;
        [Abstract]
    ...
    interface CleverTapInboxStyleConfig
    {
        ...
        // @property (nonatomic, strong) NSArray * _Nonnull messageTags;
        [Export("messageTags", ArgumentSemantic.Strong)]
        ...
        [Export("navigationTintColor", ArgumentSemantic.Strong)]
        UIColor NavigationTintColor { get; set; }

        // @property (nonatomic, strong) UIColor * _Nonnull tabSelectedBgColor;
        [Export("tabSelectedBgColor", ArgumentSemantic.Strong)]
        UIColor TabSelectedBgColor { get; set; }

        // @property (nonatomic, strong) UIColor * _Nonnull tabSelectedTextColor;
        [Export("tabSelectedTextColor", ArgumentSemantic.Strong)]
        UIColor TabSelectedTextColor { get; set; }

        // @property (nonatomic, strong) UIColor * _Nonnull tabUnSelectedTextColor;
        [Export("tabUnSelectedTextColor", ArgumentSemantic.Strong)]
